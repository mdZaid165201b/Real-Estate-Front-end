        ...
        <div class="container px-5 py-24 mx-auto" bis_skin_checked="1">
          ...
          <div class="lg:w-1/2 md:w-2/3 mx-auto" bis_skin_checked="1">
            <div class="flex flex-wrap -m-2" bis_skin_checked="1">
              <div class="p-2 w-1/2" bis_skin_checked="1">
                <div class="relative" bis_skin_checked="1">
                  ...
                  <input
                    ...
                    id="name"
                    name="name"
                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-red-500 focus:border-red-500 focus:bg-gray-200 focus:ring-1 focus:ring-red-800 text-base outline-none text-gray-600 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                  />
                </div>
              </div>
              <div class="p-2 w-1/2" bis_skin_checked="1">
              ...
              <div class="p-2 w-full" bis_skin_checked="1">
                <div class="relative" bis_skin_checked="1">
                  ...
                  <textarea
                    id="message"
                    name="message"
                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-red-500 focus:border-red-500 focus:bg-gray-200 focus:ring-1 focus:ring-red-800 h-32 text-base outline-none text-gray-600 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                  ></textarea>
                </div>
              </div>
              <div class="p-2 w-full" bis_skin_checked="1">
              ...
              <div
                class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center flex flex-col"
                bis_skin_checked="1"
              >
                <a class="text-red-500">zaidnaeem6@gmail.com</a>
                {/* <p class="leading-normal my-5">49 Smith St.
            <br/>Saint Cloud, MN 56301
          </p> */}
                {/* <span class="inline-flex justify-center mt-5">
